...
const AddDestinationPage = () => {
  ...
  return (
    <div className="container mx-auto mt-25 pb-15">
      <h2 className="font-bold text-4xl">Add Destination Page</h2>
      <Card className="max-w-7xl mx-auto  mt-10 shadow-xl w-fit">
